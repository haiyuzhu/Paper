...
随着人们对模型获取成本及便捷性要求越来越高，近年来也出现了利用单个相机重建出三维人体模型的方法~\cite{guan2009estimating,hasler2010multilinear,jain2010moviereshape,zhou2010parametric,yu2015direct}。
...
\item SCI~3~区论文：Zhu H, Yu Y, Zhou Y, Du S. Dynamic Human Body Modeling Using a Single RGB Camera. Sensors. 2016;16（3）:402.
...
\item 江苏省自然科学基金“基于骨骼运动估计的三维表面恢复与运动捕获研究”（课题年限2011.9-2014.12），负责人体三维表面恢复的研究。
\end{enumerate}
